...
public class NNet : MonoBehaviour
{
    ...
    public void Initialise(int hiddenLayerCount, int hiddenNeuronCount)
    {
        ...
        for (int i = 0; i < hiddenLayerCount + 1; i++)
        {
            ...
            Matrix<float> HiddenToOutput = Matrix<float>.Build.Dense(hiddenNeuronCount, 2);
    ...
    public NNet InitialiseCopy(int hiddenLayerCount, int hiddenNeuroCount)
    {
        NNet n = new NNet();
        ...
        n.biases = newBiases;
        n.InitialiseHidden(hiddenLayerCount, hiddenNeuroCount);
